...
export function SprintPanel({
  ...
  if (!totalCount) {
    return (
      <section className="mb-3 rounded-3xl border border-stone-200 bg-stone-50/90 p-4">
        <div className="text-xs font-semibold uppercase tracking-[0.2em] text-stone-500">Fast 25 Sprint</div>
        <h3 className="mt-1.5 font-display text-2xl text-stone-900">No actionable directories right now</h3>
  ...
  if (isComplete || !currentEntry) {
    return (
      <section className="mb-3 rounded-3xl border border-amber-200 bg-[linear-gradient(180deg,_rgba(251,243,219,0.95),_rgba(255,251,244,0.98))] p-4 shadow-[0_16px_38px_rgba(82,53,20,0.08)]">
        <div className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-700">Fast 25 Sprint</div>
        <h3 className="mt-1.5 font-display text-2xl tracking-tight text-stone-900 sm:text-3xl">Sprint complete</h3>
  ...
  return (
    <section className="mb-3 rounded-3xl border border-stone-200 bg-[linear-gradient(180deg,_rgba(255,251,244,0.98),_rgba(249,244,235,0.96))] p-4 shadow-[0_16px_38px_rgba(82,53,20,0.08)]">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <div className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-700">Fast 25 Sprint</div>
          <h3 className="mt-1.5 font-display text-2xl tracking-tight text-stone-900 sm:text-3xl">{record.name}</h3>
